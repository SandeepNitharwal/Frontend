...
const ContactUs = () => {
  ...
  return (
    <>
    <Helmet>
      <title>Contact Us | Shop Ease</title>
      <meta name="description" content="Get in touch with Shop Ease. We're here to help and answer any questions you may have." />
    </Helmet>
