      ...
      <div className="bg-gradient-to-b from-pink-50 to-pink-100 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-pink-800 mb-4 tracking-tight">Kuch to bhi text
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <h3 className="text-3xl font-bold mb-8 text-pink-900 text-center">Categories</h3>
        ...
        <footer className="bg-white py-16 text-black border-t border-pink-200">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-6">
            <div className="flex flex-col items-center md:items-start">
              <h4 className="text-3xl font-extrabold text-pink-800 mb-4">Shop Ease</h4>
